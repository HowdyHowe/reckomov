...
class FilmPageFavorite extends StatelessWidget {
  final List<DataClassFilmpage> list1 = [];
  final int id_film;
  final String title;
  FilmPageFavorite({super.key, required this.id_film, required this.title});
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: (list1.isNotEmpty &&
                                            list1[0].poster_path != false &&
                                            list1[0].poster_path.isNotEmpty)
                                        ? CachedNetworkImage(
                                            imageUrl:
                                                "https://image.tmdb.org/t/p/original${list1[0].poster_path}",
                                            placeholder: (context, url) =>
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        serviceFavoritDelete(context, id_film);
                                      },
                                      child: Row(
                                        children: [
                                          Padding(
