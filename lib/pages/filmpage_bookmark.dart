...
class FilmPageBookmark extends StatelessWidget {
  final List<DataClassFilmpage> list1 = [];
  final int id_film;
  final String title;
  FilmPageBookmark({super.key, required this.id_film, required this.title});
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        serviceBookmarkDelete(context, id_film);
                                      },
                                      child: Row(
                                        children: [
                                          Padding(
