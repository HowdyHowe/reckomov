...
Future<void> serviceBookmarkAdd(BuildContext context, id) async {
  String? email = await getEmail();
  try {
    final String url = 'http://toba.flaskhost.my.id/bookmark/post';
...
Future<void> serviceBookmarkFilm(context, List mpList) async {
  try {
    String? email = await getEmail();
    var test =
        await http.get(Uri.http('toba.flaskhost.my.id', 'bookmark/get/${email}'));
...
Future<void> serviceBookmarkDelete(BuildContext context, id) async {
  try {
    String? email = await getEmail();
    final String url = 'http://toba.flaskhost.my.id/bookmark/delete';
